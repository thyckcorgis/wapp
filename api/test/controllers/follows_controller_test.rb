...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference("Follow.count") do
      post follows_url, params: { follow: { followee_id: @follow.followee_id, follower_id: @follow.follower_id, status: @follow.status } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { followee_id: @follow.followee_id, follower_id: @follow.follower_id, status: @follow.status } }
